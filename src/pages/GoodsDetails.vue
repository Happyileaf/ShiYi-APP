<template>
  <div class="goodsDetails">
    ...
    <div class="goodsDetailsContent">
      ...
      <div class="price">
        <h1 v-text="this.price">￥{{this.price}}</h1>
      </div>
...
export default {
  ...
  methods: {
    goBack() {
      this.$router.push("/index/clothing");
    }
  },
  mounted: function(){
    // console.log("ninini")
    // console.log(window.sessionStorage.goodsId);
    axios({
      ...
      .then(res => {
        ...
        // this.=res.data[0].name
        // this.merchant.merchantTips=res.data[0].
